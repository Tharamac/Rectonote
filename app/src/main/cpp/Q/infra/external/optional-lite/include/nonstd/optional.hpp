...
/// optional
        ...
        //      && std::is_copy_assignable<T>::value
...
#endif
            {
                ...
                else if ((has_value() == true) &&
                         (other.has_value() == true)) { contained.value() = *other; }
                return *this;
            }
...
// Comparison with nullopt
        ...
        template<typename T>
        inline optional_constexpr bool
        operator<(optional<T> const & /*unused*/, nullopt_t /*unused*/) optional_noexcept {
            return false;
        }
        ...
        template<typename T>
        inline optional_constexpr bool
        operator<=(nullopt_t /*unused*/, optional<T> const & /*unused*/ ) optional_noexcept {
            return true;
        }
