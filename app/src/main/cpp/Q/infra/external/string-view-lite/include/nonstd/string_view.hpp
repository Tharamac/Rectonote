...
//
        ...
        public:
            ...
            rbegin() const nssv_noexcept { return const_reverse_iterator(end()); }

            nssv_constexpr const_reverse_iterator
            rend() const nssv_noexcept { return const_reverse_iterator(begin()); }
            ...
            max_size() const nssv_noexcept { return (std::numeric_limits<size_type>::max)(); }
            ...
            nssv_constexpr int
            compare(size_type pos1, size_type n1, basic_string_view other, size_type pos2,
            ...
            nssv_constexpr14 size_type
            find(CharT const *s, size_type pos, size_type n) const  // (3)
            {
            ...
            nssv_constexpr14 size_type
            rfind(CharT const *s, size_type pos, size_type n) const  // (3)
            {
            ...
            nssv_constexpr size_type
            find_first_of(basic_string_view v, size_type pos = 0) const nssv_noexcept  // (1)
            {
                return pos >= size()
                       ? npos
            ...
            nssv_constexpr size_type
            find_first_of(CharT const *s, size_type pos, size_type n) const  // (3)
            {
            ...
            nssv_constexpr size_type
            find_last_of(CharT const *s, size_type pos, size_type count) const  // (3)
            {
            ...
            nssv_constexpr size_type
            find_first_not_of(CharT const *s, size_type pos, size_type count) const  // (3)
            {
            ...
            nssv_constexpr size_type
            find_last_not_of(basic_string_view v, size_type pos = npos) const nssv_noexcept  // (1)
            {
                return empty()
                       ? npos
                       : pos >= size()
            ...
            nssv_constexpr size_type
            find_last_not_of(CharT const *s, size_type pos, size_type count) const  // (3)
            {
...
// ==
        ...
        nssv_constexpr bool operator==(
                basic_string_view<CharT, Traits> lhs,
                CharT const *rhs) nssv_noexcept { return lhs.compare(rhs) == 0; }
...
// !=
        ...
        nssv_constexpr bool operator!=(
                basic_string_view<CharT, Traits> lhs,
                char const *rhs) nssv_noexcept { return lhs.compare(rhs) != 0; }
...
// <
        ...
        nssv_constexpr bool operator<(
                char const *lhs,
                basic_string_view<CharT, Traits> rhs) nssv_noexcept { return rhs.compare(lhs) > 0; }
        ...
        nssv_constexpr bool operator<(
                std::basic_string <CharT, Traits> rhs,
                basic_string_view<CharT, Traits> lhs) nssv_noexcept { return rhs.compare(lhs) > 0; }
