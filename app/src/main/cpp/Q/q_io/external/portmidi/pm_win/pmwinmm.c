...
dwParam2);
static void CALLBACK
winmm_streamout_callback(HMIDIOUT
hmo,
UINT wMsg,
        DWORD_PTR
dwInstance,
...
static PmError winmm_in_open(PmInternal *midi, void *driverInfo) {
    ...
    pm_hosterror = midiInOpen(
            ...
            dwDevice,  /* device ID */
            (DWORD_PTR)
    winmm_in_callback,  /* callback address */
            (DWORD_PTR)
    midi,  /* callback instance data */
...
static PmError winmm_out_open(PmInternal *midi, void *driverInfo) {
    ...
    if (midi->latency == 0) {
        ...
        pm_hosterror = midiOutOpen(
                ...
                (DWORD_PTR)
        winmm_streamout_callback, /* callback fn */
                (DWORD_PTR)
        midi,  /* callback instance data */
