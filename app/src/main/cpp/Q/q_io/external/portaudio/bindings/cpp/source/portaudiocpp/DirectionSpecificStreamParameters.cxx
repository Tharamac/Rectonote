...
namespace portaudio {
    ...
    //////
    DirectionSpecificStreamParameters::DirectionSpecificStreamParameters(const Device &device,
                                                                         int numChannels,
    ...
    void DirectionSpecificStreamParameters::setHostApiSpecificSampleFormat(PaSampleFormat format,
                                                                           bool interleaved) {
    ...
    SampleDataFormat DirectionSpecificStreamParameters::sampleFormat() const {
        if (isSampleFormatHostApiSpecific())
            ...
            return static_cast<SampleDataFormat>(paStreamParameters_.sampleFormat &
                                                 ~paNonInterleaved);
    }
