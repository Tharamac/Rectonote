...
namespace portaudio {
    namespace impl {
        ...
        //////
        int cppCallbackToPaCallbackAdapter(const void *inputBuffer, void *outputBuffer,
                                           unsigned long numFrames,
                                           const PaStreamCallbackTimeInfo *timeInfo,
                                           PaStreamCallbackFlags statusFlags, void *userData) {
            FunCallbackStream::CppToCCallbackData *data = static_cast<FunCallbackStream::CppToCCallbackData *>(userData);
            return data->funPtr(inputBuffer, outputBuffer, numFrames, timeInfo, statusFlags,
                                data->userData);
        }
    }
    ...
    FunCallbackStream::CppToCCallbackData::CppToCCallbackData(CallbackFunPtr funPtr, void *userData)
    ...
    FunCallbackStream::FunCallbackStream(const StreamParameters &parameters, CallbackFunPtr funPtr,
                                         void *userData) : adapterData_(funPtr, userData) {
        open(parameters);
    }
    ...
    void FunCallbackStream::open(const StreamParameters &parameters, CallbackFunPtr funPtr,
                                 void *userData) {
