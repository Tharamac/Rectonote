...
namespace portaudio {
    ...
    public:
        ...
        virtual int
        paCallbackFun(const void *inputBuffer, void *outputBuffer, unsigned long numFrames,
    ...
    namespace impl {
        extern "C"
        {
        int callbackInterfaceToPaCallbackAdapter(const void *inputBuffer, void *outputBuffer,
