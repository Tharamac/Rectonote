...
namespace portaudio {
    ...
    private:
        ...
        public:
            ...
            MemFunToCallbackInterfaceAdapter(T &instance, CallbackFunPtr memFun) : instance_(
                    &instance), memFun_(memFun) {}
            ...
            int paCallbackFun(const void *inputBuffer, void *outputBuffer, unsigned long numFrames,
                ...
                return (instance_->*memFun_)(inputBuffer, outputBuffer, numFrames, timeInfo,
                                             statusFlags);
            }
